...
public class UserService {
    ...
    public User addUser(String userName, String email, String mobileNumber, String password) {
        User currentUser = new User(userName, email, mobileNumber, password);
    ...
    public User authenticateUser(String email , String password){
        ...
        if (!currentUser.getPassword().equals(password)) throw new RuntimeException("Invalid credentials");
